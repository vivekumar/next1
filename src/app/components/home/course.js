    ...
    <div className="edu-course-area course-area-1 edu-section-gap bg-lighten01">
      <div className="container">
              ...
              <div className="inner">
                <div className="thumbnail">
                  <a href="course-details.html">
                    <Image src="/assets/images/course/course-07.jpg" alt="Course Meta">
                  </a>
          ...
          <div className="col-md-6 col-xl-3" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
            <div className="edu-course course-style-1 hover-button-bg-white">
              <div className="inner">
                <div className="thumbnail">
                  <a href="course-details.html">
                    <Image src="/assets/images/course/course-04.jpg" alt="Course Meta">
                  </a>
                  <div className="time-top">
          ...
          <div className="col-md-6 col-xl-3" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
            <div className="edu-course course-style-1 hover-button-bg-white">
              <div className="inner">
                <div className="thumbnail">
                  <a href="course-details.html">
                    <Image src="/assets/images/course/course-05.jpg" alt="Course Meta">
                  </a>
                  <div className="time-top">
          ...
          <div className="col-md-6 col-xl-3" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
            <div className="edu-course course-style-1 hover-button-bg-white">
              <div className="inner">
                <div className="thumbnail">
                  <a href="course-details.html">
                    <Image src="/assets/images/course/course-06.jpg" alt="Course Meta">
                  </a>
                  <div className="time-top">
        ...
        <div className="course-view-all" data-sal-delay="150" data-sal="slide-up" data-sal-duration="1200">
          <a href="course-one.html" className="edu-btn">Browse more courses <i className="icon-4"></i></a>
        </div>
      </div>
    </div>
  )
