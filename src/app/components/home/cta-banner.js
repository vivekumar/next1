        ...
        <div className="edu-cta-banner">
          ...
          <ul className="shape-group">
            <li className="shape-01 scene">
              <Image data-depth="2.5" src="/assets/images/cta/shape-10.png" alt="shape">
            </li>
            <li className="shape-02 scene">
              <Image data-depth="-2.5" src="/assets/images/cta/shape-09.png" alt="shape">
            </li>
            <li className="shape-03 scene">
              <Image data-depth="-2" src="/assets/images/cta/shape-08.png" alt="shape">
            </li>
