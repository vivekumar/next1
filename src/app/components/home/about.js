        ...
        <div className="row g-5 align-items-center">
          <div className="col-lg-6">
            <div className="about-image-gallery">
              <Image className="main-img-1" src="/assets/images/about/about-01.webp" alt="About Image">
                <div className="video-box" data-sal-delay="150" data-sal="slide-down" data-sal-duration="800">
                  <div className="inner">
                    <div className="thumb">
                      <Image src="/assets/images/about/about-02.webp" alt="About Image">
                ...
                <ul className="shape-group">
                  <li className="shape-1 scene" data-sal-delay="500" data-sal="fade" data-sal-duration="200">
                    <Image data-depth="1" src="/assets/images/about/shape-36.png" alt="Shape">
                  </li>
                  <li className="shape-2 scene" data-sal-delay="500" data-sal="fade" data-sal-duration="200">
                    <Image data-depth="-1" src="/assets/images/about/shape-37.png" alt="Shape">
                  </li>
                  <li className="shape-3 scene" data-sal-delay="500" data-sal="fade" data-sal-duration="200">
                    <Image data-depth="1" src="/assets/images/about/shape-02.png" alt="Shape">
                  </li>
                </ul>
            </div>
          </div>
