              ...
              <div className="header-mainnav">
                <nav className="mainmenu-nav">
                  <ul className="mainmenu">
                    ...
                    <li className="has-droupdown"><Link href="#">Courses</Link> </li>
        ...
        <div className="popup-mobile-menu">
          <div className="inner">
            ...
            <ul className="mainmenu">
              ...
              <li className="has-droupdown"><Link href="#">Courses</Link>
                <ul className="submenu">
                  <li><Link href="course-one.html">Course Style 1</Link></li>
                  <li><Link href="course-two.html">Course Style 2</Link></li>
                  <li><Link href="course-three.html">Course Style 3</Link></li>
                  <li><Link href="course-four.html">Course Style 4</Link></li>
                  <li><Link href="course-five.html">Course Style 5</Link></li>
                  <li><Link href="course-details.html">Course Details 1</Link></li>
                  <li><Link href="course-details-2.html">Course Details 2</Link></li>
                  <li><Link href="course-details-3.html">Course Details 3</Link></li>
                </ul>
              </li>
